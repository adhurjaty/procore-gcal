...
class ProcoreSettingsDto(DtoBase):
    ...
    def email_settings(self):
        return self._settings_to_dict_list(self.parent.email_settings or {})

    def _settings_to_dict_list(self, settings):
        return [{'name': s.name, 'enabled': s.enabled} for s in settings]
    ...
    def calendar_event_types(self):
        return self._settings_to_dict_list(self.parent.calendar_event_types or {})
